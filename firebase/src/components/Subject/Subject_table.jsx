...
export default function Subject_table({ data }) {
        ...
        <TableBody>
          {data.map((e) => (
            <StyledTableRow key={e.id}>
              ...
              <StyledTableCell align="center">{e.Subject_name}</StyledTableCell>
              <StyledTableCell align="center">{e.Subject_class}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
